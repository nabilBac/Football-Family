 ...
 * 
 * // SimpMessagingTemplate est utilisé pour envoyer des messages sur le canal
 * WebSocket
 * public VideoScheduler(VideoService videoService, SimpMessagingTemplate
 * messagingTemplate) {
 ...
 * System.out.println("SCHEDULER: Mise à jour agrégée lancée pour " +
 * videoIdsToUpdate.size() + " vidéos.");
 * 
 ...
 * messagingTemplate.convertAndSend("/topic/video/" + videoId,
 * currentLikesCount);
 * }
 * }
 * }
